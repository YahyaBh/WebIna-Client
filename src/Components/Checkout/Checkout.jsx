...
const Checkout = () => {
    ...
    const { sec_http, isAuthenticated, user } = AuthUser();
        ...
        if (nameInput === '') {
            if (emailInput === '') {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Please fill the name and email field'
                })
            } else {
                if (method === '') {
                    Swal.fire({
                                ...
                                <div className="left-cont">
                                    ...
                                    <div className="informations">
                                        ...
                                        <div className="input-cont">
                                            ...
                                            <input type="text" name='full-name' id='full-name' defaultValue={user?.name} onChange={(e) => { setNameInput(e.target.value) }} />
                                        </div>
                                        ...
                                        <div className="input-cont">
                                            ...
                                            <input type="email" name='email' id='email' defaultValue={user?.email} onChange={(e) => { setEmailInput(e.target.value) }} />
